...
import { HorizontalBarView } from "../components/views/HorizontalBarView";
import { HorizontalCategoryBarView } from "../components/views/HorizontalCategoryBarView";

import "./TimebookPage.css";

export function TimebookPage() {
